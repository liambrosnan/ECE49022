...
#define cc1101_Select()  digitalWrite(15, LOW)
// Deselect (spiH) CC1101
//#define cc1101_Deselect()  digitalWrite(SS, HIGH)
#define cc1101_Deselect()  digitalWrite(15, HIGH)
...
void CC1101::configureGPIO(void)
{
  ...
  pinMode(15, OUTPUT);                       // Make sure that the SS Pin is declared as an Output
#endif
...
#endif
    Serial.println("Brayden was here");
    Serial.println("Sam was here first, he just didn't advertise it");
